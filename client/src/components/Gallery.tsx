  ...
  return (
    <section id="gallery" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-display font-bold text-center mb-4 section-heading">{t('gallery.title')}</h2>
        <p className="text-center text-neutral-600 mb-12 max-w-xl mx-auto">{t('gallery.subtitle')}</p>
